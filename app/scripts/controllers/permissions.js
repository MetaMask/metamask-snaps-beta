...
const pluginRestrictedMethodsDescriptions = {
  ...
  approvePermissionsRequest: 'Approve account access for a given domain',
  buyEth: 'Forwards the user to the easiest way to obtain ether for the currently-selected network',
  cancelMessage: 'Cancel the signing of a given message',
  cancelPersonalMessage: 'Cancel the signing of a given personal message',
  cancelTransaction: 'Cancel a transaction',
  cancelTypedMessage: 'Cancel the signing of a given typed message',
  checkHardwareStatus: 'Check if the hardware device is unlocked',
  clearPermissions: 'Remove account access for all domains',
  completeOnboarding: 'Complete the onboarding process',
  connectHardware: 'Fetch account list from a Trezor device',
  createCancelTransaction: 'Cancel a transaction by submitting a replacement',
  createNewVaultAndKeychain: 'Create a new Vault and create a new key chain',
  createNewVaultAndRestore: 'Create a new Vault and restore an existent keyring',
  createShapeShiftTx: 'Triggers a ShapeShift currency transfer',
  createSpeedUpTransaction: 'Speed up a transaction by submitting a replacement',
  delCustomRpc: 'Delete a selected custom URL',
  estimateGas: 'Estimate the gas required for a transaction',
  exportAccount: 'Export the current account',
  ...
  getState: 'Get a JSON representation of MetaMask data',
  ...
  markAccountsFound: 'Legacy; will be removed in the future',
  markPasswordForgotten: 'Allows a user to begin the seed phrase recovery process',
  rejectPermissionsRequest: 'Reject account access for a given domain',
  ...
  retryTransaction: 'Retry a transaction',
  ...
  setFirstTimeFlowType: 'Choose the first-time flow: create or import',
  setLastActiveTime: 'Set the last active time of MetaMask',
  setLocked: 'Mark MetaMask as locked',
  setMetaMetricsSendCount: 'Update the rate at which metrics are sent using MetaMetrics',
  ...
  signMessage: 'Sign a given message',
  signPersonalMessage: 'Sign a given message using a personal signature scheme',
  signTypedMessage: 'Sign a given typed message',
  submitPassword: 'Submits the user password and attempts to unlock the vault',
  ...
  updateAndApproveTransaction: 'Update a transaction and mark is as approved',
